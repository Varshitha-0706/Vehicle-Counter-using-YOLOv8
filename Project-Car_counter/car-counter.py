...
# Force PyTorch checkpoint loading to allow older Ultralytics weights on newer torch versions
...
if not os.path.exists(model_path):
    print(f"Model path {model_path} not found, falling back to 'yolov8n.pt'. This may download weights automatically.")
